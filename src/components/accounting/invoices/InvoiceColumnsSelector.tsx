...
interface InvoiceColumnsSelectorProps {
  columns: InvoiceColumn[];
  onChange: (columns: InvoiceColumn[]) => void;
}

export const InvoiceColumnsSelector = ({ columns, onChange }: InvoiceColumnsSelectorProps) => {
  const [selectedColumns, setSelectedColumns] = useState<InvoiceColumn[]>(columns);
...
export default InvoiceColumnsSelector;
