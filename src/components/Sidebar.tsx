...
export function Sidebar({
  ...
  const isHoaPage = location.pathname === '/hoa/dashboard' || 
  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className={cn("pb-12 border-r min-h-screen bg-background w-[260px] transition-all duration-300", className)}>
        <SidebarContent className="space-y-2 py-3">
          <SidebarHeader className="py-1 px-4 my-0 animate-fade-in">
            <HoverCard>
                  ...
                  {settings.logoUrl ? (
                    <>
                      <img 
                        ...
                        className="h-12 max-w-[200px] object-contain transition-all duration-300 hover:scale-105" 
                      />
                      <TooltipProvider>
                        <Tooltip>
                    ...
                    <>
                      <div className="text-lg font-semibold tracking-tight transition-all duration-300 hover:text-primary">
                        PS Management
                      </div>
                      <TooltipProvider>
                        <Tooltip>
              ...
              <HoverCardContent className="w-80">
                <div className="space-y-2">
                  <h4 className="text-sm font-semibold">Company Settings</h4>
                  <p className="text-sm text-muted-foreground">
                    Click to modify your company branding, logo, and display preferences.
                  </p>
                </div>
              </HoverCardContent>
            </HoverCard>
            ...
            <div className="space-y-1">
              {NAV_ITEMS.map((item, i) => {
                ...
                if (navItem.items && navItem.items.length > 0) {
                  return (
                    <div key={navItem.label} className="animate-fade-in animate-delay-100">
                      <CollapsibleNavItem 
                        item={navItem} 
